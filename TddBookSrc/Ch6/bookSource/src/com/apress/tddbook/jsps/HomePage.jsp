...
<p align="center">
   ...
   <%
    ...
    String poolStatus = pool.getStatus();
    out.println("Pool Status " +  poolStatus);
    out.println("</p> <div align='center'> <center>");
    out.println("<table border='1' bordercolordark='#FFFFFF'>");
    out.println("<tr>");
    out.println("<td bgcolor='#C0C0C0'>This Weeks Games</td>");
    out.println("<tr>");
    if(pool != null)
    {
    ...
    out.println("</center>");
    out.println("</div>");
    if(poolStatus.equals("Open"))
    {
       out.println("<p align='center'><a href='Pick%20Sheet.htm'>Make your Picks</a>&nbsp; ");
    }
    else
    {
      out.println("<a href='Pick%20Summary.htm'>View Pick Summary</a>&nbsp;");
    }
    %>
