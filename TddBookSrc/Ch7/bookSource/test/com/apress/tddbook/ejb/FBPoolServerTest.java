...
public class FBPoolServerTest extends DatabaseTestCase
{
    ...
    {
        return new FlatXmlDataSet(new FileInputStream("datasetEJB1.xml"));
    }
    ...
    {
        //FBPoolServerEJB fbPoolServer = new FBPoolServerEJB();
    ...
    public void xtestGetPoolStatus()
    {
        try
        {
            FBPoolServerEJB fbPoolServer = new FBPoolServerEJB();
